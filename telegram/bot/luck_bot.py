...
def airdrop(update, context):
    bot = telepot.Bot(TOKEN)
    bot.sendMessage(chat_id = '@official_LUCK_community',
                   text = "✨AIRDROP Event for Pre-sale Participants✨\n\n🎁$LUCK TOKENS GIVEAWAY FOR EARLY ADOPTERS!🎁\n✔️ Airdrop starts 2022-01-25\n✔️ Airdrop ends 2022-01-27\n✔️ Airdrop Link: Go to Airdrop\n✔️ Total value: 50,000,000 $LUCK +a\n✔️ Platform: Binance Smart Chain\n\nLUCK is airdropping a total of 50,000,000 $LUCK +a to users who participate in pre-sale. Submit your details to the airdrop page to receive $LUCK.\n\n💕Who's eligible?💕\nPre-sale Participants\n\n🏆Lucky winners🏆\n(a) 7,777,777 $LUCK tokens for 3 people who made the maximum buy\n(b) 777,777 $LUCK tokens for 7 people who purchase more than 1BNB (First-come, first-served basis)\n(c) (need to revise) 77,777 $LUCK tokens for all people who participate in pre-sale\n\nStep-by-Step Guide:\n1. Visit the LUCK airdrop page.\n2. Submit your details and sign up.\n3. Now buy $LUCK on Pinksale.\n4. Submit your details to the giveaway page.\n5. All participants will be randomly selected to win $1~100 worth of LUCK each.\n6. The rewards will be distributed by the end of February 2022.\n7. Don’t forget to join our Telegram channel, follow us on Twitter to receive new airdrops!\n\nRequirements:\n✔️ E-Mail required\n✔️ Wallet address required\n✔️ Made a minimum buy on pink sale\n✔️ Solve Anti-Abusing Quiz\n\n🍀Good luck!🍀",
                   parse_mode = "Markdown")
def main():
